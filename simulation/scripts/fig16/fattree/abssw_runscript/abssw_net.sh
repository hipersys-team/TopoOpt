...
mkdir $resultdir
bash -c "cd $resultdir && $HOME/FlexFlow/ffsim-opera/src/clos/datacenter/htsim_tcp_abssw_multijob -simtime 3600.1 -flowfiles $jobsstr -speed $((b*1000)) -ofile nwsim_linkft.txt -nodes $n -ssthresh 10000 -rtt 1000 -q 100000"
